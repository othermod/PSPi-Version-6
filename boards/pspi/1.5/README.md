...
- **DC jack power control**: Use EN_5V to control power flow to DC jack (instead of V_USB). This will kill external power input/output earlier and prevent issues where the FETs may latch on when the board is over 100°C.
