...
source "arm" "raspios_zero_arm" {
  ...
  image_path            = "PSPi6.PiOS.4-3.32bit.Zero.${var.pspi_version}.img"
  image_size            = "4G"
  image_type            = "dos"
...
source "arm" "raspios_cm4_zero2_arm64" {
  ...
  file_unarchive_cmd    = ["xz", "--decompress", "$ARCHIVE_PATH"]
  image_build_method    = "resize"
  image_path            = "PSPi6.PiOS.4-3.64bit.CM4-Zero2.${var.pspi_version}.img"
  image_size            = "4G"
  image_type            = "dos"
...
source "arm" "retropie_zero_arm" {
  ...
  file_unarchive_cmd    = ["gunzip", "$ARCHIVE_PATH"]
  image_build_method    = "resize"
  image_path            = "PSPi6.RetroPie.4-8.32bit.Zero.${var.pspi_version}.img"
  image_size            = "4G"
  image_type            = "dos"
...
source "arm" "retropie_zero2_arm" {
  ...
  file_unarchive_cmd    = ["gunzip", "$ARCHIVE_PATH"]
  image_build_method    = "resize"
  image_path            = "PSPi6.RetroPie.4-8.32bit.Zero2.${var.pspi_version}.img"
  image_size            = "4G"
  image_type            = "dos"
...
source "arm" "retropie_cm4_arm" {
  ...
  file_unarchive_cmd    = ["gunzip", "$ARCHIVE_PATH"]
  image_build_method    = "resize"
  image_path            = "PSPi6.RetroPie.4-8.32bit.CM4.${var.pspi_version}.img.gz"
  image_size            = "4G"
  image_type            = "dos"
